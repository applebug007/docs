...
<AccordionGroup>
  <Accordion title="Temporal Inconsistency Analysis">
    Analyzes frame-by-frame changes to detect unnatural temporal patterns typical of AI generation
  </Accordion>

  <Accordion title="Facial Landmark Detection">
    Examines facial feature positioning and movement patterns for anomalies
  </Accordion>
  ...
  <Accordion title="Biological Signal Analysis">
    Detects missing or irregular biological signals like pulse, breathing, and micro-expressions
  </Accordion>

  <Accordion title="Neural Network Fingerprinting">
    Identifies specific AI models used for generation based on their unique signatures
  </Accordion>
</AccordionGroup>
...
<AccordionGroup>
  <Accordion title="Spectral Analysis">
    Examines audio frequency patterns and harmonics for synthetic generation artifacts
  </Accordion>

  <Accordion title="Prosodic Feature Analysis">
    Analyzes speech rhythm, stress patterns, and intonation for unnatural variations
  </Accordion>

  <Accordion title="Glottal Flow Analysis">
    Examines vocal cord vibration patterns that are difficult to replicate synthetically
  </Accordion>

  <Accordion title="Speaker Verification">
    Compares voice characteristics against known authentic samples
  </Accordion>

  <Accordion title="Real-time Streaming Analysis">
    Detects synthetic speech in live conversations and phone calls
  </Accordion>
</AccordionGroup>
