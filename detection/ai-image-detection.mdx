...
<CardGroup cols={2}>
  <Card title="API Reference" icon="book" href="/api-reference/endpoint/ai-content-detection">
    Complete API documentation and examples
  </Card>
  <Card title="Health Monitoring" icon="heart-pulse" href="/detection/health-monitoring">
...
<CardGroup cols={2}>
  <Card title="Production Deployment" icon="rocket" href="/detection/production-deployment">
    Deploy the AI detection service in production
  </Card>
  <Card title="API Overview" icon="gauge" href="/api-reference/api-overview">
    Learn about endpoints and usage
  </Card>
</CardGroup> 