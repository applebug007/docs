...
# Voice Clone Detection Health Check

Monitor the health, performance, and accuracy of your voice clone detection system to ensure reliable operation and optimal protection against synthetic speech attacks.
...
<CardGroup cols={2}>
  <Card
    title="API Reference"
    icon="code"
    href="/api-reference/voice/health"
  >
  ...
  >
    Comprehensive voice detection API integration guide
  </Card>
</CardGroup> 